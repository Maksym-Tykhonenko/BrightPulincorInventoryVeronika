...
import BrightPulincorInventoryProdScr from './PulincorInventory/screens/BrightPulincorInventoryProdScr';
...
const App = () => {
  ...
  const INITIAL_URL = `https://superb-dominant-glory.space/`;
  const URL_IDENTIFAIRE = `ZSeg6Nzb`;
  ...
  OneSignal.initialize('70abbb6f-51ba-4515-95fb-3bd2d2bd340a');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-06-10T13:00:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="BrightPulincorInventoryProdScr"
            component={BrightPulincorInventoryProdScr}
    ...
    return (
      <Stack.Navigator
        initialRouteName={"PulincorWarehouse"}
        screenOptions={{
          headerShown: false
        }}
      >
      ...
      {!louderPrevIsEnded || !aceptTransperency || !completeLink ? (
        ...
        style={{
          position: 'relative',
            ...
            alignItems: 'center',
          backgroundColor: '#73048b',
        }}>
        <Animated.Image
          source={require('./PulincorInventory/materials/pulincorImgs/pulincorLogo.png')}
          style={{
            //...props.style,
