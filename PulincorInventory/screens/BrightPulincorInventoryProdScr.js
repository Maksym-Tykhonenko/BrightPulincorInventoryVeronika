...
const BrightPulincorInventoryProdScr = ({navigation, route}) => {
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../materials/pulincorBtns/arrow77.png')}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../materials/pulincorBtns/redo77.png')}
          />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
...
export default BrightPulincorInventoryProdScr;
